...
def main():
    ...
    parser.add_argument('--opt', type=str, default='/code/STEN/options/train/train_Enhance_Middlebury.yml', help='Path to option YAML file.') ### You can choose it as "train_Enhance_Holopix.yml"
